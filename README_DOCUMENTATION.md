# HamSCI Contesting and DXing Dashboard - Technical Documentation
...
└─────────────────┬───────────────────────────┘
                  ...
                  ↓
┌─────────────────────────────────────────────┐
│        MongoDB Database (***REDACTED_HOST***)         │
│              wspr_db.spots                  │
...
pip install flask pymongo maidenhead geopandas shapely geopy
```
...
Edit [web-ft.py](web-ft.py:35-38) to configure MongoDB connection:

```python
# Production PSWS server
...
**Backend** ([web-ft.py](web-ft.py:198)):
```python
rxlat, rxlon = maidenhead.to_location("FN21ni")  # Change to your grid
```

**Frontend Table View** ([table_ft.js](static/js/table_ft.js:39)):
```javascript
const call = "KD3ALD"  // Change to your callsign
```

**Frontend Map View** ([map_ft.js](static/js/map_ft.js:491)):
```javascript
...
Band colors are defined in [map_ft.js](static/js/map_ft.js:210-226):
...
**File:** [templates/index_ft.html](templates/index_ft.html), [static/js/map_ft.js](static/js/map_ft.js)
...
**File:** [templates/table_ft.html](templates/table_ft.html), [static/js/table_ft.js](static/js/table_ft.js)
...
├── web-mongo.py               # Alternate version (country filtering)
├── web-time.py                # Alternate version (time filtering)
...
**Database Changes:**
- Connect to MongoDB: `mongo --host ***REDACTED_HOST*** --port 27017 -u admin -p ***REDACTED***`
...
2. **Read filter value** in [map_ft.js](static/js/map_ft.js) `loadSpots()`:
   ```javascript
...
**Error:** `ServerSelectionTimeoutError: ***REDACTED_HOST***:27017`

**Solutions:**
- Check MongoDB server is running: `systemctl status mongod`
- Verify network connectivity: `ping ***REDACTED_HOST***`
- Check firewall rules allow port 27017
- Verify credentials in [web-ft.py](web-ft.py:35)
...
- [HamSCI Workshop 2025 Poster](Ruzankski,%20Owen%20-%20FRC_W3USR_POSTER.pdf) - Project overview and goals
- [FRC Proposal](FRC%20Proposal.pdf) - Detailed project proposal
- [WSPRDaemon Documentation](http://***REDACTED***.org/) - PSWS software documentation
...
Software developed by this project will be released under open source licenses. Check individual files for specific license information.
...
**GitHub Issues:**
(Add repository URL when project is open-sourced)

---

*This documentation was generated as part of the HamSCI PSWS Dashboard Development project, Spring 2025.*
